...
(function(){
    ...
    self.Ball.prototype = {
        ...
        collision: function (bar) {
            //Funcion para tratar las colisiones con las barras (raquetas)
            var relative_interset_y = (bar.y + (bar.height)/2)-this.y;
            var normalized_intersect_y = relative_interset_y / (bar.height/2);
    ...
    self.BoardView.prototype = {
        ...
        check_collision: function () {
            for (var i = this.board.bars.length - 1; i >= 0; i--) {
                ...
                if (hit(bar, this.board.ball)){ //Valida la colision entre elementos
